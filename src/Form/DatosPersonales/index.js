  ...
  return (
    ...
    >
      <TextField
        ...
        helperText={
          name.valid === false && "Ingresa un nombre de usuario valido"
        }
        value={name.value}
        onChange={(input) => {
      ...
      <TextField
        ...
        helperText={
          lastName.valid === false && "Ingresa un apellido de usuario valido"
        }
      ...
      <TextField
        ...
        helperText={
          phone.valid === false &&
          "Ingresa un numero de telefono valido que contenga 10 dígitos)"
        }
        value={phone.value}
        onChange={(input) => {
